"""Architect system prompt for Scaffold AI.

This system prompt is used by the architect Lambda function (apps/functions/architect/)
to design AWS architectures via Bedrock. The placeholder ArchitectAgent class has been
removed — architecture design now runs entirely through Step Functions + Strands.
"""
...
|------|---------|-------------|
| `frontend` | React + Vite | Static site with CloudFront + S3 |
