...
export const StorageNode = memo(function StorageNode({ data, selected }: NodeProps<AppNode>) {
  return (
    <div className={`relative px-4 py-3 rounded-lg border-2 bg-white shadow-md min-w-[150px] ${selected ? "border-pink-500 ring-2 ring-pink-200" : "border-pink-300"}`}>
