...
export const FirehoseNode = memo(function FirehoseNode({ data, selected }: NodeProps<AppNode>) {
  return (
    <div className={`relative px-4 py-3 rounded-lg border-2 bg-white dark:bg-zinc-800 shadow-md min-w-[150px] ${selected ? "border-teal-500 ring-2 ring-teal-200" : "border-teal-300"}`}>
      ...
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <div className="text-xs text-gray-500 dark:text-gray-400">Data Firehose</div>
        </div>
      </div>
